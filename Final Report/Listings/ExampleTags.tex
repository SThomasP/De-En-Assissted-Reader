\begin{lstlisting}[language=HTML, caption={[Example HTML Code] An example of how the HTML code of the article ended up appearing after it had been formatted.}, label=lst:html, breaklines=true]
<p>
