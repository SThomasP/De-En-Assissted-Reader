...
\mainmatter
%% ----------------------------------------------------------------
\include{Chapters/Introduction}         % Proofreading 3
\include{Chapters/ProjectPlan}          % Proofreading 3
\include{Chapters/BackgroundReading}    % Proofreading 3
\include{Chapters/ApplicationOutline}   % Proofreading 3
\include{Chapters/ApplicationDesign}    % Proofreading 3
\include{Chapters/ApplicationLogic}     % Proofreading 3
\include{Chapters/UserTesting}          % Proofreading 3
\include{Chapters/Evaluation}           % Proofreading 3
\include{Chapters/Conclusion}           % Proofreading 3
\appendix
